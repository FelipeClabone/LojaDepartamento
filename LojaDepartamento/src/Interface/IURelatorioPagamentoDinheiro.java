 ...
 * @author lucas
 */
public class IURelatorioPagamentoDinheiro extends javax.swing.JDialog {

    /**
     * Creates new form IURelatorioCliente
     */
    public IURelatorioPagamentoDinheiro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object [][] linha = controle.retornarRelatorioDinheiro();
        
        
        
        DefaultTableModel modelo = (DefaultTableModel) produto_Table.getModel();
        for(int cont = 0; cont < controle.retornarRelatorioDinheiro().length; cont++){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IURelatorioPagamentoDinheiro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IURelatorioPagamentoDinheiro dialog = new IURelatorioPagamentoDinheiro(new javax.swing.JFrame(), true);
