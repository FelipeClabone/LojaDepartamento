 ...
 * @author lucas
 */
public class IURelatorioCliente extends javax.swing.JDialog {

    /**
     * Creates new form IURelatorioCliente
     */
    public IURelatorioCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object [][] linha = controle.retornarRelatorioCliente();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IURelatorioCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IURelatorioCliente dialog = new IURelatorioCliente(new javax.swing.JFrame(), true);
