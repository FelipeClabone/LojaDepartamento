 ...
 * @author lucas
 */
public class IURelatorioPagamentoCartao extends javax.swing.JDialog {

    /**
     * Creates new form IURelatorioCliente
     */
    public IURelatorioPagamentoCartao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object [][] linha = controle.retornarRelatorioCartaoCredito();
        
        
        
        DefaultTableModel modelo = (DefaultTableModel) produto_Table.getModel();
        for(int cont = 0; cont < controle.retornarRelatorioCartaoCredito().length; cont++){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IURelatorioPagamentoCartao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IURelatorioPagamentoCartao dialog = new IURelatorioPagamentoCartao(new javax.swing.JFrame(), true);
