 ...
 * @author lucas
 */
public class IURelatorioFornecedor extends javax.swing.JDialog {

    /**
     * Creates new form IURelatorioCliente
     */
    public IURelatorioFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object [][] linha = controle.retornarRelatorioFornecedor();
        
        DefaultTableModel modelo = (DefaultTableModel) produto_Table.getModel();
        for(int cont = 0; cont < controle.retornarRelatorioFornecedor().length; cont++){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IURelatorioFornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IURelatorioFornecedor dialog = new IURelatorioFornecedor(new javax.swing.JFrame(), true);
